...
public class Retour_1 extends AppCompatActivity {
    ListView listView;
    String mStation[]={"El Khairia","Bou Ain","Becha", "Bab El Aaidi","El Zalouza","Kaanich","Diwen El Zit","El Blaket","Markaz Bou Assida",
            "Lycée Mohamed Ali","Mosquée El Bousten","El Jad","Seka","Ecole Français","Chaaben","Ariana","Beaux-Arts",
            "Sabra","5 Aout","Bab Diwen","El Khairia","Bou Ain","Becha", "Bab El Aaidi","El Zalouza","Kaanich","Diwen El Zit","El Blaket","Markaz Bou Assida",
            "Lycée Mohamed Ali","Mosquée El Bousten","El Jad","Seka","Ecole Français","Chaaben","Ariana","Beaux-Arts",
            "Sabra","5 Aout","Bab Diwen"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retour_1);




        listView = findViewById(R.id.listview_retour);
        // now create an adapter class

        Retour_1.MyAdapter adapter = new Retour_1.MyAdapter(this, mStation, mTime, images);
    ...
    class MyAdapter extends ArrayAdapter<String> {
        ...
        MyAdapter (Retour_1 c, String[] station, String[] time, int[] imgs) {
